        ...
        <div class="subpage-content">
            ...
            <div v-if="weatherData.length" class="forecast-container">
                <div v-for="forecast in weatherData" :key="forecast.date" class="forecast-card">
                  ...
                  <!-- Show loading text if no data has been fetched and there is no error -->
...
<script>
// Import the function to fetch weather forecast data from an API
